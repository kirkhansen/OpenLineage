...
public class MetastoreTestUtils {
    ...
    public static SparkConf getCommonSparkConf(String appName, String metastoreName, int mappedPort, Boolean isIceberg) {
        ...
        SparkConf conf = new SparkConf()
                ...
                .set("fs.gs.auth.service.account.private.key.id", GOOGLE_SA_PROPERTIES.get("private_key_id"))
    ...
    public static void createSampleFiles(SparkSession spark, String basePath, String database, String table, Boolean isIceberg) {
